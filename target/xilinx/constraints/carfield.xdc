...
# JTAG Clock
#create_clock -period $JTAG_TCK -name clk_jtag_safety_island [get_ports jtag_safety_island_tck_i]
#set_input_jitter clk_safety_island_jtag 1.000
...
#set_input_delay  -min -clock clk_jtag_safety_island [expr 0.10 * $JTAG_TCK] [get_ports {jtag_safety_island_tdi_i jtag_tms_i}]
#set_input_delay  -max -clock clk_jtag_safety_island [expr 0.20 * $JTAG_TCK] [get_ports {jtag_safety_island_tdi_i jtag_tms_i}]

#set_output_delay -min -clock clk_jtag_safety_island [expr 0.10 * $JTAG_TCK] [get_ports jtag_safety_island_tdo_o]
#set_output_delay -max -clock clk_jtag_safety_island [expr 0.20 * $JTAG_TCK] [get_ports jtag_safety_island_tdo_o]

#set_max_delay  -from [get_ports jtag_safety_island_trst_ni] $JTAG_TCK
#set_false_path -hold -from [get_ports jtag_safety_island_trst_ni]
